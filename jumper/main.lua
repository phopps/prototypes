...
function love.load()
  ...
  love.window.setTitle("Some Game Thing")
...
function checkCollisions()
  ...
  for i,plat in ipairs(platforms) do
    ...
    if plat_left < player_right and plat_right > player_left and plat_top < player_bottom and plat_bottom > player_top then
      print("COLLIDE")
    elseif plat_left < player_right and plat_right > player_left and plat_top < player_bottom+10 and plat_bottom > player_top then
      --print("feet touch")
